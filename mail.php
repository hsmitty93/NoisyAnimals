 ...
 * ===================================================== */
$email_to = "hsmitty93@gmail.com"; // the email address to which the form sends submissions
$email_from = "hsmitty93@gmail.com"; // the email address used as "From" when submissions are sent to the $email_to above (important that it has the same domain as the domain of your site - unless you have configured your server's mail settings)
